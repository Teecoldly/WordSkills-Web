...
$result = $orderproduct ->GetOrderbuy();
?>
<!DOCTYPE html>
<html lang="en">
  <head>
 ...
 <body>
    ...
    <h5 class="card-title text-center h3 mb-5 pt-5 mt-5">รายการสินค้าที่ได้สั่งซื้อ</h5>
    <div class="container">
      <div class="row">
        <div class="col-12">
        <table class="table text-center border">
            ...
            <tbody>
                ...
                <tr> 
                  ...
                  <th  ><?php echo $genaral->PrintStausSend($value["Order_send"]);?></th>
                </tr>
              <?php } ?> 
            </tbody>
          </table>
