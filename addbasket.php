    ...
    <h5 class="card-title text-center h3 mb-5 pt-5 mt-5">เพิ่มรายการลงตะกร้าสินค้า</h5>
      <div class="row justify-content-center mr-2 ml-2 "> 
        <div class="col-sm-12 col-md-5  "> 
            <form action="./Event/Addbasket.php?ID=<?php echo $result["data"]["product_ID"]?>&GrouplistiD=<?php echo $result["data"]["GrouplistiD"]?>" method="post">
                <div class="form-row">
                ...
                <div class="col-sm-12 col-md-6 mt-2">
                    ...
                    <div class="col-sm-12 col-md-12 mt-2">
                        ...
                        <input type="number"  require   min="1" max="<?php echo $result["data"]["product_amout"] ;?>" name="totalbuy" class="form-control" placeholder="กรุณากรอกจำนวนที่ต้องการซื้อ">
                    </div>
                </div>  
